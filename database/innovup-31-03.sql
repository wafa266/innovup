...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 31 mars 2021 à 22:53
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Customer infos';
...
(2, 'mellakh', 'wafa', 'mellakhwafa868@gmail.com', NULL, '+21624727423', NULL, NULL, NULL, NULL);
...
(2, 4, 0, '2021-03-29 23:14:28', '2021-03-29 23:14:28', NULL, 1, NULL);
...
(6, 'painau chocolat', 12, 1, NULL, NULL, NULL, 17, NULL, NULL, NULL),
(7, 'pain', 12, 1, NULL, NULL, NULL, 17, NULL, NULL, NULL);
...
(30, 'mellakh', 'wafa', 'mellakhwafa8@gmail.com', 'nhDr7OyKlXQju+Ge/WKGrPQ9lPBSUFfpK+B1xqx/+8zLZqRNX0+5G1zBQklXUFy86lCpkAofsExlXiorUcKSNQ==', '+21624727423', NULL, '2021-03-29 23:14:48', '2021-03-29 23:14:48', NULL);
