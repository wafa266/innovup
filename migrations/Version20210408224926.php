 ...
 */
final class Version20210408224926 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_provider_orders (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, quantity INT DEFAULT NULL, INDEX IDX_80951BE34584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product_provider_orders ADD CONSTRAINT FK_80951BE34584665A FOREIGN KEY (product_id) REFERENCES product (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product_provider_orders DROP FOREIGN KEY FK_80951BE34584665A');
        ...
        $this->addSql('DROP TABLE product_provider_orders');
