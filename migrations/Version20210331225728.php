 ...
 */
final class Version20210331225728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE customer_orders (id INT AUTO_INCREMENT NOT NULL, customer_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, is_paid TINYINT(1) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, INDEX product_id_fk_idx (id), INDEX customer_id_fk_idx (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE customer_orders_product (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, customer_orders_id INT DEFAULT NULL, quantity INT DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_BB52421C4584665A (product_id), INDEX IDX_BB52421C640362CC (customer_orders_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(45) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, tva DOUBLE PRECISION DEFAULT NULL, price_excluding_tax DOUBLE PRECISION DEFAULT NULL, price_ttc DOUBLE PRECISION DEFAULT NULL, barcode VARCHAR(250) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_D34A04AD12469DE2 (category_id), INDEX category_id_fk_idx (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE provider (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(45) DEFAULT NULL, last_name VARCHAR(45) DEFAULT NULL, email VARCHAR(45) DEFAULT NULL, address VARCHAR(45) DEFAULT NULL, phone VARCHAR(45) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE provider_orders (id INT AUTO_INCREMENT NOT NULL, provider_id INT DEFAULT NULL, is_paid TINYINT(1) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, INDEX product_id_fk_1_idx (id), INDEX provider_id_fk_idx (provider_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE provider_orders_product (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, provider_orders_id INT DEFAULT NULL, quantity INT DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_7AE2B97E4584665A (product_id), INDEX IDX_7AE2B97E16608264 (provider_orders_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE customer_orders_product ADD CONSTRAINT FK_BB52421C4584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE customer_orders_product ADD CONSTRAINT FK_BB52421C640362CC FOREIGN KEY (customer_orders_id) REFERENCES customer_orders (id)');
        ...
        $this->addSql('ALTER TABLE provider_orders_product ADD CONSTRAINT FK_7AE2B97E4584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE provider_orders_product ADD CONSTRAINT FK_7AE2B97E16608264 FOREIGN KEY (provider_orders_id) REFERENCES provider (id)');
    }
